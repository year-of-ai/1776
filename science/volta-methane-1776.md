...
# Alessandro Volta's Discovery of Methane

**Category**: Science & Discovery | **Date**: November 1776
...
- [Buffon's Natural History](buffon-natural-history.md) — the other major 1776 natural-philosophy enterprise, advancing experimental science within the Enlightenment.
- [David Hume's Death and Philosophical Legacy](david-hume-1776.md) — the empiricist outlook that framed the experimental method Volta applied to gases.
- [Benjamin Franklin & 1776 Diplomacy](../people/benjamin-franklin-1776.md) — Franklin's writings on flammable swamp gas prompted Volta's Lake Maggiore investigation.
- [James Watt's Steam Engine](../economics/james-watt-steam-engine.md) — the contemporaneous 1776 technology whose combustion principles methane would later help illuminate.
